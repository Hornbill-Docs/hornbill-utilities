...
* [Download the ZIP archive](https://github.com/hornbill/Hornbill-Cleaner-Utility/releases/latest) relevant to your OS and architecture. This contains the cleaner executable, configuration file and license.
